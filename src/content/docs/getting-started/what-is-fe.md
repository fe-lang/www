...
Fe 26.0 is an initial release of a new compiler. It has known bugs, a limited standard library, and generates sub-optimal bytecode in some cases. See the [release announcement](https://blog.fe-lang.org/posts/fe-redux/) for details.
:::
