---
title: Workspaces
description: Manage multiple ingots in a single Fe project using a workspace fe.toml
---
...
**Note:** “Workspace” here refers to Fe ingot workspaces (`fe.toml`), not the Rust/Cargo workspace used to build the Fe compiler.
...
`members` is required; a workspace without members emits a diagnostic.
